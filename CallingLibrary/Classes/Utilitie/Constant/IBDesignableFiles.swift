...
class CustomView: UIView {
    ...
    let callBtns: UIButton = {
        ...
        let image = UIImage(url: URL(string: "https://dev-api-t10.vgroupinc.com/dev_c2c_p82/product/channel/ur/65aa0a4e632f4cae4f9433d9/connect.png"))?.withRenderingMode(.alwaysOriginal)
    ...
    let smsBtns: UIButton = {
       ...
       // let image = Constant.getImage(named: "sms")?.withRenderingMode(.alwaysOriginal)
        let image = UIImage(url: URL(string: "https://dev-api-t10.vgroupinc.com/dev_c2c_p82/product/channel/ur/65aa0a4e632f4cae4f9433d9/sms.png"))?.withRenderingMode(.alwaysOriginal)
    ...
    let emailBtns: UIButton = {
        ...
        let image = UIImage(url: URL(string: "https://dev-api-t10.vgroupinc.com/dev_c2c_p82/product/channel/ur/65aa0a4e632f4cae4f9433d9/email.png"))?.withRenderingMode(.alwaysOriginal)
